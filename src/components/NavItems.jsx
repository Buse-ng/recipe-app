  ...
  return (
    <>
      <div className="h-full px-3 py-4 md:p-0 overflow-y-auto bg-gray-200 md:bg-transparent">
        ...
        <ul className="space-y-2 md:space-y-0 font-medium md:flex md:items-center md:justify-center">
          {/* home */}
          <li>
            <Link
              to="/"
          ...
          <li>
            ...
            >
              ...
              <span className="md:hidden inline-flex items-center justify-center w-3 h-3 p-3 ms-3 
